...
# %% [markdown]
# ##### Aqui eu filtro o dataframe criando outro a partir do principal com os dados necessários para criar o gráfico geográfico. As colunas de soma são adicionadas apenas para retirar o grupo com maior registro de casos por município.
...
# %% [markdown]
# ##### Agora, finalmente, temos nosso geomap mostrando a quantidade de casos por município. Nesse primeiro vou utilizar os nomes como chave. Quanto mais roxo, menor o número e quanto mais amarelado, maior o número. 
...
# %% [markdown]
# ##### Agora criarei um gráfico de barras simples reutillizando o df usado aneriormente como filtro e removendo apenas a coluna com os municípios, pois não será utilizada. Este gráfico mostra apenas quantidade de casos por grupo vulnerável no total.
